...
<head>
    ...
    <script>
        ...
        function backToDestination() {
            location.href="update-destination.php?id=" + <?=$_GET['id']?>;
        }
...
if ($_SESSION["isAdmin"] === true) {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<title>" . $row['destination'] . " foto-volgorde aanpassen - Lift a Boat</title>";
            ...
            if (!array_filter($imageArray)) {
                ...
                echo "<h2>Aanpassen afbeeldingsvolgorde " . $row['destination'] . "</h2>";
...
<script>
    ...
    function updateImageOrder() {
        ...
        orderLink = "update_order_destinations.php?id=" + id + "&image=" + imageArray + "&text=" + textArray;
